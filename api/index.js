export default function handler(req, res) {
  ...
  const REDIRECT_URI = "https://shopify-sync-snowy.vercel.app/api/index";
  ...
  .then(data => {
    if (data.access_token) {
      ...
      res.end(`<html><body style="font-family:sans-serif;max-width:600px;margin:60px auto;padding:20px"><h2 style="color:green">✅ Your token:</h2><p style="background:#e8f5e9;padding:20px;border-radius:8px;font-family:monospace;word-break:break-all">${data.access_token}</p></body></html>`);
    } else {
